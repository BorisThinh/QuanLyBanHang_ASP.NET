...
namespace QuanLyBanHang.Controllers
{
    public class SanPhamController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSP,TenSP,Donvitinh,Dongia,MaLoaiSP,HinhSP")] 
        SanPham sanPham, HttpPostedFileBase HinhSP)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSP,TenSP,Donvitinh,Dongia,MaLoaiSP,HinhSP")] 
        SanPham sanPham, HttpPostedFileBase HinhUpLoad, string HinhSP)
        {
            if (ModelState.IsValid)
            {
